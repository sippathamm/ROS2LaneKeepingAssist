...
def setup_var_protocol():
    ...
    return [1],['mcu_state'],['std_msgs/Bool.msg'],[['bool']],[['data']],[[False]],[[1]],[[88]],[[1]]
...
class Publisher_node(Node):
    ...
    def __init__(self):
        super().__init__('xicro_publisher_node_f1tenth_mega')
...
class Subscriber_node(Node):
    def __init__(self,Obj_uart):
        super().__init__('xicro_subscriber_node_f1tenth_mega')
        self.Obj_uart = Obj_uart
...
class Srv_client_node(Node):
    def __init__(self,Obj_uart,OnIdsrv,Ongrab,sequence):
        super().__init__('xicro_service_client_node_f1tenth_mega_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
...
class Action_client_node(Node):
    def __init__(self,Obj_uart,OnIdaction,Ongrab,sequence):
        super().__init__('xicro_action_client_node_f1tenth_mega_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
