...
Date: August 6, 2024.
File: steering_predictor_node.py
"""
...
class SteeringPredictorNode(Node):
    def __init__(self) -> None:
        super().__init__('steering_predictor_node')
    ...
    def __image_callback(self, msg: Image) -> None:
        ...
        self.update_debug_image(background, steering_angle)
    ...
    def update_debug_image(self, background: np.ndarray, steering_angle: float) -> None:
        ...
        cv2.putText(background, 'Predicted steering angle: ' + str(steering_angle),
                    (30, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
